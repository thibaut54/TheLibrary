...
//		styles.add( GenericBuilder.of( Style::new )
//						.with( Style::setStyle, StyleName.CHILDREN.toString() )
//						.build());
//		styles.add( GenericBuilder.of( Style::new )
//				            .with( Style::setStyle, StyleName.CULTURE.toString() )
//				            .build());
//		styles.add( GenericBuilder.of( Style::new )
//				            .with( Style::setStyle, StyleName.EDUCATION.toString() )
//				            .build());
//		styles.add( GenericBuilder.of( Style::new )
//				            .with( Style::setStyle, StyleName.FANTASY.toString())
//				            .build());
//		styles.add( GenericBuilder.of( Style::new )
//				            .with( Style::setStyle, StyleName.LITERATURE_FICTION.toString())
//				            .build());
//		this.styleRepository.saveAll( styles );
//
//		//-----SET STYLE OF BOOK
//		List<Style> stylesBook1 = new ArrayList<>();
//		stylesBook1.add( this.styleRepository.findAll().get( 1 ) );
//		stylesBook1.add( this.styleRepository.findAll().get( 2 ) );
//		Book book = this.bookRepository.findAll().get( 0 );
//		book.setStyles( stylesBook1 );
